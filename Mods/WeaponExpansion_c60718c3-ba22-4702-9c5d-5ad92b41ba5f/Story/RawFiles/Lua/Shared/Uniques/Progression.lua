...
local bonuses = {
	...
	BeholderSword = {
		...
		[10] = ue:Create("Boosts", "_Boost_Weapon_Cleave_Large_TwoHanded"),
		[12] = ue:Create("CriticalChance", 10),
		[14] = ue:Create("Boosts", "_LLWEAPONEX_Boost_Weapon_Damage_Corrosive_Beholder_Rank2"),
		[15] = runeslot2,
	},
	Bible = {
	...
	Blunderbuss = {
		...
		[7] = runeslot1,
		[8] = ue:Create("Boosts", "_Boost_Weapon_Damage_Fire_Large"),
