...
Ext.Require("WeaponExpansion_c60718c3-ba22-4702-9c5d-5ad92b41ba5f", "Shared/Data/MasteryBonusParams.lua")

---@class TranslatedString
local TranslatedString = LeaderLib.Classes["TranslatedString"]

---@type table<string,TranslatedString>
local RuneNames = Ext.Require("WeaponExpansion_c60718c3-ba22-4702-9c5d-5ad92b41ba5f", "Shared/Data/RuneNameHandles.lua")
WeaponExpansion.Text.RuneNames = RuneNames

---@type table<string,TranslatedString>
local MasteryRankTagText = Ext.Require("WeaponExpansion_c60718c3-ba22-4702-9c5d-5ad92b41ba5f", "Shared/Data/MasteryRankTagText.lua")
